...
-}"""
	...
	def test_get_transaction_reference_falls_back_to_transaction_reference_as_last_resort(self):
		"""When customer_reference is the NONREF sentinel and no bank_reference is present,
		fall back to the statement-level transaction_reference as a last resort."""
		self.assertEqual(
			get_transaction_reference(
				{
					"customer_reference": "NONREF",
